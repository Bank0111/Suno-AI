...
4. ZERO CLICHÉS (แบนคำโหลและวลีซ้ำซาก):
   ...
   5. CONVERSATIONAL LYRICS (เนื้อเพลงที่มาจากภาษาพูดในชีวิตจริง):
   - เนื้อเพลงต้องแต่งเพื่อนำไป "ร้อง" แต่คำศัพท์และรูปประโยคต้องมาจาก "ภาษาพูดในชีวิตประจำวัน" (Conversational Tone)
   - ห้ามใช้ภาษาเขียน ภาษานิยาย กลอนโบราณ หรือคำประดิษฐ์ที่คนปกติไม่พูดกัน (ห้ามใช้คำเช่น: "ดวงตาพราว", "แพ้พ่าย", "รินไหล", "แสงไฟสลัวส่องกระทบ")
   - เน้นความ "Real" และ "ติดดิน" เล่าเรื่องด้วยคำธรรมดาง่ายๆ แต่นำมาร้องให้เจ็บลึกและเข้าปากคนไทยที่สุด
