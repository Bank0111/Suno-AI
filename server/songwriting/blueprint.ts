...
9. LUKTHUNG & PHUEA CHIWIT POETIC EMOTION LAWS (กฎการประพันธ์กลอนลูกทุ่งเพื่อชีวิต):
   ...
   - CONTEXTUAL COHERENCE: ห้ามสุ่ม Imagery หรือวัตถุที่ไม่เข้ากับวิถีชีวิตไทย/ลูกทุ่ง/เพื่อชีวิต (เช่น หีบเพลงชัก, งานเต้นรำ, งานวัดร้าง, เทียนไข) ให้เลือกใช้เฉพาะภาพจริง เช่น แคร่ไม้, กลิ่นฟาง, มอเตอร์ไซค์เก่า, คันแทนา, เสาไฟทาง, หมอนขิด, หลังคาสังกะสี
