...
1. SHOW, DON'T TELL (เล่าด้วยภาพและสัญญะ):
   - ห้ามเขียนความรู้สึกออกมาตรงๆ ทื่อๆ (เช่น ห้ามใช้คำว่า "ฉันเศร้ามาก", "ฉันรักเธอ", "เจ็บปวดเหลือเกิน", "คิดถึงเธอ")
   - บังคับให้ใช้ "ภาพจำ", "บรรยากาศ", หรือ "การกระทำ" เพื่อสื่ออารมณ์แทน 
   - (ตัวอย่าง: แทนที่จะบอกว่าเศร้า ให้เขียนว่า "มองกาแฟแก้วเดิมที่น้ำแข็งละลาย", แทนที่จะบอกว่ารัก ให้เขียนว่า "ซ่อนตั๋วหนังใบเก่าไว้ในหนังสือ")

2. METAPHORS & IMAGERY (อุปมาอุปไมยขั้นสุด):
   - ดึงคำศัพท์จากหมวด [Poetic & Metaphorical] ในคลังของคุณมาผสมผสานให้เกิดบริบทใหม่
   - สร้างการเปรียบเปรยที่คาดไม่ถึง แต่เข้าถึงอารมณ์คนฟัง (เช่น เปรียบความเงียบเหมือนเสียงตะโกน, เปรียบการรอคอยเหมือนเข็มนาฬิกาที่หยุดเดิน)
...
4. ZERO CLICHÉS (แบนคำโหลและวลีซ้ำซาก):
   ...
   5. NATURAL CONVERSATIONAL TONE (ความเป็นธรรมชาติและภาษาพูด):
   - แม้จะใช้การเปรียบเปรย แต่เนื้อเพลงต้องออกมาเป็น "ภาษาพูด" ที่ไหลลื่น ร้องเข้าปากคนไทยจริงๆ ห้ามใช้ภาษาเขียนหรือสำนวนประดิษฐ์
   - ห้ามใช้คำศัพท์ที่ดูเป็นนิยายแปล ลิเก หรือวรรณกรรมจ๋าเกินไป (ห้ามใช้คำเช่น: "ดวงตาพราว", "แพ้พ่าย", "แสงไฟสลัวส่องกระทบ", "ฤทัย")
   - เน้นความ "Real" และ "ติดดิน" ใช้คำธรรมดาง่ายๆ ในชีวิตประจำวันมาร้อยเรียงให้เจ็บลึก (Simple words, Deep impact)
