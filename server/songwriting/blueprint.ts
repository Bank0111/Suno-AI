...
9. LUKTHUNG & PHUEA CHIWIT POETIC EMOTION LAWS (กฎการประพันธ์กลอนลูกทุ่งเพื่อชีวิต):
   - Metaphor Pairing: ผูกประสาทสัมผัสธรรมชาติเข้ากับบาดแผลในใจเสมอ
     * ฝน / หยาดน้ำตา = ความเปียกปอน, คนรักเก่า, แผลเดิมที่ยังไม่แห้ง
     * ลมหนาว / คืนมืด = ความอ้างว้าง, การถูกทิ้งซ้ำสอง, ความเจ็บที่บาดลึก
     * ฤดูกาล / กาลเวลา = ห้วงเวลาการรักษาใจ หรือความสุขที่แสนสั้น
   - Parallel Meter & Cadence: วางคำคู่ขนานและสร้างสัมผัสใน (Internal Rhymes) ทุกวรรคเพื่อการร้องที่เข้าปากและลื่นไหลตามจังหวะ 4/4
   - Dual-Wound Architecture: ขยี้ความรู้สึกแผลซ้อนแผลและทวงถามความเห็นใจอย่างตรงไปตรงมา
   - CONTEXTUAL COHERENCE & DYNAMIC IMAGERY:
     * วัตถุและฉาก (Imagery/Sensory) ต้องดึงมาจาก "Story Prompt" ของผู้ใช้โดยตรงเท่านั้น
     * ห้ามยัดเยียดวัตถุซ้ำซากประจำแนวเพลง (ห้ามสแปมคำว่า โต๊ะไม้, ชานไม้, ชายคา, แคร่ไม้, กลิ่นฟาง ในทุกเพลง) หากโจทย์ไม่ได้ระบุ
     * ให้คัดสรรวัตถุที่เป็นรูปธรรมและเข้ากับสถานที่จริงของเรื่องเล่าในแต่ละเพลงอย่างสมเหตุสมผล
