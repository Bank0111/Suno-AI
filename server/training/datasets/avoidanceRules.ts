...
export const AVOIDANCE_RULES: AvoidanceRuleEntry[] = [
  ...
  {
    id: 'avoid-ctx-006',
    termOrPhrase: 'ประแจ / น็อต / ไขควง / คราบน้ำมัน / น้ำมันเครื่อง / ชุดเซฟตี้ / หัวเทียน / สายพาน / เครื่องจักร / อู่ซ่อมรถ / แม่กุญแจ / เครื่องยนต์ / อะไหล่รถ / คันไถ / เกี่ยวข้าว (ในท่อน Chorus / Hook / Bridge)',
    tier: 'CONTEXTUAL_AVOID',
    contextConditions: {
      sections: ['Chorus', 'Hook', 'Bridge'],
    },
    reason: 'ท่อนฮุกและบริดจ์ต้องเป็นพื้นที่ของแก่นอารมณ์และสัจธรรมชีวิต การยัดเยียดชื่ออุปกรณ์ช่างหรือเครื่องมือการเกษตรหลายคำรวมกันทำให้เพลงเสียความลึกซึ้ง (Vocational/Object Dump) — คำเดียวที่มีหน้าที่เชิงภาพหรือสัญลักษณ์ยังใช้ได้ตามปกติ',
